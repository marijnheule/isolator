...
int main (int argc, char** argv) {
  ...
  if ((nEdge ==  6) && (nClass !=   11)) { printf("ERROR: not all classes are present\n"); exit (0); }
  if ((nEdge == 10) && (nClass !=   34)) { printf("ERROR: not all classes are present\n"); exit (0); }
  if ((nEdge == 15) && (nClass !=  156)) { printf("ERROR: not all classes are present\n"); exit (0); }
  if ((nEdge == 21) && (nClass != 1044)) { printf("ERROR: not all classes are present\n"); exit (0); }
